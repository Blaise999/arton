// app/emails/CertifiedPartnerLeadAutoReply.tsx
import * as React from "react";

interface CertifiedPartnerLeadAutoReplyProps {
  fname?: string;
}
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    >
                      ...
                      >
                        Certified Partner Inquiry Received
                      </p>
                      ...
                      <p style={{ margin: "0 0 12px" }}>
                        ...
                        <strong>Certified Partner</strong> of Arton Capital.
                      </p>

                      <p style={{ margin: "0 0 12px" }}>
                        Our team will carefully review your information and
                        contact you within <strong>24 hours</strong> to discuss
                        the partnership opportunity and how we can support your
                        High Net Worth clients.
                      </p>

                      <p style={{ margin: "0 0 12px" }}>
                        If you have any urgent questions in the meantime, simply
                        reply to this email and one of our advisors will assist
                        you.
                      </p>

                      <p style={{ margin: "0 0 18px" }}>
                        We look forward to exploring how we can empower Global
