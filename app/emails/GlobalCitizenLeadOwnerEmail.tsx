// app/emails/GlobalCitizenLeadOwnerEmail.tsx
import * as React from "react";

type Field = { label: string; value: string };

interface GlobalCitizenLeadOwnerEmailProps {
  fullName: string;
  email: string;
  fname?: string;
  lastname?: string;
...
export default function GlobalCitizenLeadOwnerEmail({
  fullName,
  email,
  fields,
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p style={{ margin: "0 0 16px" }}>
                        ...
                        <strong>“Become a Global Citizen”</strong> form.
                      </p>
                      ...
                      <div style={{ marginTop: 24 }}>
                        <a
                          href={`${siteUrl}/become-a-global-citizen`}
                          style={{
                            display: "inline-block",
                            padding: "10px 20px",
                            borderRadius: 999,
