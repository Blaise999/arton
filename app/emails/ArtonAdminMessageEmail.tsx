// app/emails/ArtonAdminMessageEmail.tsx
import * as React from "react";

interface ArtonAdminMessageEmailProps {
  subject: string;
  message: string;
}

export function ArtonAdminMessageEmail({
  subject,
  message,
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p style={{ margin: "0 0 4px" }}>
                        1 Westmount Square, Suite 1110, Montreal, Quebec, H3Z 2P9
                      </p>
