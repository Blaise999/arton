        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 md:flex-row md:items-center md:py-20">
          <div className="md:w-1/2">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight md:text-4xl">
              One dedicated{" "}
              <span className="text-[#cc9966]">email channel</span> for all your
              enquiries.
            </h1>
            <p className="mt-4 text-sm text-white/80 md:text-base">
              Share your situation, family structure, desired timelines and
              preferred destination in one detailed message. Our team will reply
              with tailored options, clear pricing and next steps.
            </p>
